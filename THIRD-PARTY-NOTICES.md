...
| 组件 | 用途 | 许可证 | 许可文本 |
|------|------|--------|----------|
| Ark Pixel Font（方舟像素字体·12px/16px proportional zh_cn） | 全游戏 UI 字体 | SIL Open Font License 1.1 | 随包 `assets/font/`（OFL 全文见 fusion-pixel-OFL.txt 同款条款·上游 https://github.com/TakWolf/ark-pixel-font） |
