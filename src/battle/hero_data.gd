...
static func _hero_defs() -> Array[Dictionary]:
	return [
		{id="h01", name="子鼠", hp=8,  role="经济型", position="首发",   skill_type=SkillType.EXTRA_ACTION, extra_action=12, desc="【财源广进】主动技能。记录一次「双倍攒」机会（全队通用），下一次「攒」获得的能量翻倍。使用后下回合无法连续使用"},
		...
		{id="h06", name="巳蛇", hp=10, role="反制型", position="中核",   skill_type=SkillType.EXTRA_ACTION, extra_action=9, desc="【蛇蜕】消耗2能。本回合若死亡，复活为1HP，本局后续波/防永久升级为大波/大防"},
		{id="h07", name="午马", hp=12, role="经济型", position="轮转",   skill_type=SkillType.PASSIVE, passive_id="wuma", desc="切换上场时获得1护盾；切换下场时，下个登场英雄获得1护盾"},
		{id="h08", name="未羊", hp=12, role="经济型", position="中核",   skill_type=SkillType.EXTRA_ACTION, extra_action=10, desc="【舍身】消耗2HP，获得3能量"},
		...
		{id="h13", name="愚者", hp=10, role="娱乐型", position="灵活",   skill_type=SkillType.EXTRA_ACTION, extra_action=13, desc="【不可知之权柄】消耗0能。随机执行波/大波/防/大防/攒之一。开局前HP在8-14中随机"},
