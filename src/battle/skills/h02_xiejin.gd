...
## h02 牛金【山岳为屏】被动 · 防御 · 坦克(HP6 = 12 半点·2026-07-06 批④ 7→6：大轮 60.7% 新头部·
##   引擎全靠挨打次数驱动 → HP 刀=身板+触发总量双重收敛·不碰机制·文案零变动·仍在 DraftAI 坦克档 HP≥6)
...
##   agency / yomi：对手两难——打牛金 = 喂全队护盾(资敌)、不打 = 放着 HP6 肉墙挡路；
