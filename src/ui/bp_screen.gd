...
# 每行 [起始索引, 卡数, x0]。**6 列锁定（Eddy 2026-06-24·与图鉴一致）**：首发 20 = 6+6+6+2 四行，末行 2 卡左对齐列 0-1（x0=602=6 卡居中起点·对齐池心 960）。
# 配 ROW_Y0=256 把 4 行居中进池面板（210-874·容得下）；扩张到 24 = 6×4 满四行。
const ROWS: Array = [[0, 6, 602.0], [6, 6, 602.0], [12, 6, 602.0], [18, 2, 602.0]]
