...
- **道具系统**：3 槽 3 选 1，不占动作、能量为闸门；当前正式池 87 件（T1 31 / T2 39 / T3 17），给阵容加上千变万化的搭配。
...
- ✅ 首发 57 件道具实装。
- ✅ GUT 测试套件全绿（38 脚本 / 423 用例 / 1530 断言·2026-07-17·精确数以实跑为准）。
...
- 道具：`design/items-firstrelease.md`（首发 57 件真相源）
