...
## ============================================================================
## BattleEngineV4 英雄第一批（Step 2.2c）
...
func _battle_p0(hero_id: String, hp: int, e: int = 6) -> BattleEngineV4:
...
func test_h02_numu_no_bonus_at_full_hp() -> void:
	...
	b.select_action(0, ActionDefV4.Action.ATTACK)
	b.select_action(1, ActionDefV4.Action.CHARGE)
	b.resolve()
...
func test_h02_numu_buffs_big_attack_too() -> void:
	var b := _battle_p0("h02", 6)
	b.hp[0][0] = 10
	b.select_action(0, ActionDefV4.Action.BIG_ATTACK)
	b.select_action(1, ActionDefV4.Action.CHARGE)
	b.resolve()
...
func test_h05_tianwei_normal_attack_no_bonus() -> void:
	var b := _battle_p0("h05", 6)
	b.select_action(0, ActionDefV4.Action.ATTACK)   # 波非大波
	b.select_action(1, ActionDefV4.Action.CHARGE)
	b.resolve()
...
func test_h01_qieyun_steals_one_energy() -> void:
	...
	b.select_action(1, ActionDefV4.Action.DEFEND)   # 防：能量不变
	b.resolve()
...
func test_h01_qieyun_capped_at_3() -> void:
	...
	for i in range(3):
		...
		b.select_action(1, ActionDefV4.Action.DEFEND)
		b.resolve()
...
func test_h21_xianglong_reduces_big_attack() -> void:
	...
	b.select_action(0, ActionDefV4.Action.CHARGE)
	b.select_action(1, ActionDefV4.Action.BIG_ATTACK)   # 2.0 → 力量减到 1.0
	b.resolve()
...
func test_h21_xianglong_does_not_reduce_wave() -> void:
	...
	b.select_action(0, ActionDefV4.Action.CHARGE)
	b.select_action(1, ActionDefV4.Action.ATTACK)        # 1.0 不减
	b.resolve()
