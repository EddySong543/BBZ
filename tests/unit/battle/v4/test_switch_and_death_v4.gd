...
## ============================================================================
## BattleEngineV4 切换 + 死亡结算测试（Step 2.2b）
##
...
func test_switch_changes_active_and_costs_zero() -> void:
	...
	assert_eq(b.energy[0], E_INIT, "切换 0 能消耗")
...
func test_jia_attack_hits_newly_switched_in_hero() -> void:
	...
	var b := _battle()
	b.select_switch(0, 1)
	b.select_action(1, ActionDefV4.Action.ATTACK)
	b.resolve()
...
func test_active_death_with_reserves_sets_pending_switch() -> void:
	...
	b.select_action(1, ActionDefV4.Action.BIG_ATTACK)  # 2.0 伤 → 致死
	b.resolve()
...
func test_execute_death_switch_brings_in_reserve() -> void:
	...
	b.hp[0][0] = 2
	b.select_action(0, ActionDefV4.Action.CHARGE)
	b.select_action(1, ActionDefV4.Action.BIG_ATTACK)
	b.resolve()
...
func test_all_heroes_dead_is_game_over() -> void:
	...
	assert_eq(b.winner, BattleEngineV4.WINNER_P2, "player0 全灭 → 对手 player1 胜 = WINNER_P2")
