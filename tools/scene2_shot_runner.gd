...
## 输出：D:/Game/BoBoZan/_probe_output/scene2_shot_a/b.png（仓库外·勿入库）
...
func _ready() -> void:
	...
	await _shot("D:/Game/BoBoZan/_probe_output/scene2_shot_a.png")
	await get_tree().create_timer(0.6).timeout
	await _shot("D:/Game/BoBoZan/_probe_output/scene2_shot_b.png")
	get_tree().quit()
