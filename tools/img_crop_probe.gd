...
## 输出：D:/Game/BoBoZan/_probe_output/crop_battle_items_p1/p2.png（仓库外）
...
func _initialize() -> void:
	...
	var shot := Image.load_from_file("D:/Game/BoBoZan/_probe_output/battle_screen_shot.png")
	if shot != null:
		_crop(shot, Rect2i(20, 160, 230, 90), "D:/Game/BoBoZan/_probe_output/crop_battle_items_p1.png")
		_crop(shot, Rect2i(1670, 160, 230, 90), "D:/Game/BoBoZan/_probe_output/crop_battle_items_p2.png")
	quit()
