...
```
  ...
  引擎专家（使用与你的引擎匹配的专家集）:
    ...
    unity-specialist   -- Unity 负责人：MonoBehaviour/DOTS、Addressables、URP/HDRP
      ...
      unity-addressables-specialist -- 资产：异步加载、资源包、内存、CDN
    ...
    godot-specialist   -- Godot 4 负责人：GDScript、节点/场景、信号、资源
      ...
      godot-shader-specialist      -- 着色器：Godot 着色器语言、可视化着色器、VFX
      godot-gdextension-specialist -- 原生绑定：C++/Rust 绑定、GDExtension、构建系统
```
